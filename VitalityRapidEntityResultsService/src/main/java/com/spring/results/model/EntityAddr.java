...
public class EntityAddr {
	...
	public EntityAddr(int addrId, String addrLine1, String addrType, String dateTimeLastModified, String defaultRecord,
			String osUserLastModified, String postCd, String requestingEntity, String sessUserLastModified,
			String street, String suburb, String tenantId, String townOrCity) {
		super();
		this.addrId = addrId;
		this.addrLine1 = addrLine1;
		this.addrType = addrType;
